            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="relative">
                {deity.youtube_videos?.sacred_iconography ? (
                  ...
                  <div className="aspect-video bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl flex items-center justify-center">
                    <p className="text-gray-500">Video content coming soon</p>
                  </div>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="relative">
                {deity.youtube_videos?.divine_symbolism ? (
                  ...
                  <div className="aspect-video bg-gradient-to-br from-purple-50 to-orange-50 rounded-xl flex items-center justify-center">
                    <p className="text-gray-500">Video content coming soon</p>
                  </div>
                )}
              </div>
