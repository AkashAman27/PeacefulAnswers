        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative group">
              <button className="flex items-center space-x-2 px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-orange-600 hover:bg-orange-50 transition-colors">
                  ...
                  <div key={item.name}>
                    ...
                    {item.dropdown && (
                      <div className="ml-8 space-y-1 mt-1">
                        {item.dropdown.slice(0, -1).map((dropdownItem) => ( // Exclude "All X" items
                          <Link
                            key={dropdownItem.href}
                            href={dropdownItem.href}
